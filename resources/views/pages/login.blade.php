...
<div id="tpp-wrapper">
	...
	<div class="container">
					...
					<div class="row no-gutters">
						<div class="col-lg-6 col-md-8 col-md-offset-2 col-lg-offset-3 bg-white">
							...
							<div class="tx-center pd-h-3 pd-v-3">
							    <a name="next" class="action-button next button dtran pd-v-5 pd-h-3 tx-center tx-white bg-lightblue bg-hv-white tx-hv-blue no-dec">
		...
		<!--
		<div class="row">
			<div class="col-lg-6 col-md-8 col-md-offset-2 col-lg-offset-3 bg-white pd-h-1 pd-v-3">
				<div class="mg-v-3 headfont heavyfont upperfont tx-lightblue text-center ft-1">
					WELCOME!
				</div>
				<div class="bodyfont tx-center ft-4">
					<strong>The People Project</strong> is connecting the country's best political staffers and policy wonks with jobs and appointments which need those unique skills that only experience can provide.  <br>
					Registration is all it takes to start having your profile sent to the top political HR shops in the country. It's also <em>completely free</em>.  All you need to do is verify you are you through LinkedIn and complete the quick survey that follows.
				<div class="mg-v-1 tx-center">
				    <a id="login" class="button dtran pd-v-5 pd-h-3 tx-center tx-white bg-lightblue bg-hv-white tx-hv-blue no-dec">
						<span class="headfont upperfont heavyfont no-dec ft-3">Build your Profile</span>
					</a>
				</div>
			</div>
